...
export class EmployeeCreate extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { fullName: '', birthdate: '', tin: '', employeeTypeId: 1, salary: '', loading: false, loadingSave: false };
    }
                ...
                <form>
                    ...
                    <div className="form-row">
                        ...
                        <div className='form-group col-md-6'>
                            ...
                            <select onChange={this.handleChange.bind(this)} value={this.state.employeeTypeId} name="employeeTypeId" id="inputEmployeeType4" className='form-control'>
