...
namespace Sprout.Exam.WebApp
{
    public class Startup
    {
        ...
        {
            services.AddDbContextPool<SproutExamDbContext>(opt =>
            ...
            services.AddAutoMapper(typeof(EmployeeTypeMapper));
            ...
            services.AddTransient<ISalaryComputationService, SalaryComputationService>();
            services.AddScoped<ISalaryComputationRepository, SalaryComputationRepository>();
