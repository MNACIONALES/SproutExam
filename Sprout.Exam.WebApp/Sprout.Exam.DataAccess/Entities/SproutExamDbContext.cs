...
namespace Sprout.Exam.DataAccess.Entities
{
    public partial class SproutExamDbContext : DbContext
    {
        ...
        public virtual DbSet<SalaryComputation> SalaryComputations { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalaryComputation>(entity =>
            {
                ...
                entity.HasOne(d => d.EmployeeType)
                    .WithMany(p => p.SalaryComputations)
                    .HasForeignKey(d => d.EmployeeTypeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_SalaryComputations_EmployeeType");
            });
